...
(println "\nCombined foods, merge-with 'str'(concat) on conflict:"
         (merge-with str favorite_foods more_foods))

; sorted maps
(def favorite_foods_sorted
  (sorted-map "Joe" "pizza" "John" "burgers" "Bob" "corn dogs"))
